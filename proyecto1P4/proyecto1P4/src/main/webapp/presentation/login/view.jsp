                ...
                <div class="modal-content">
                    ...
                    <form class="col-12" method="POST" name="Entrar" action="/proyecto1P4/presentation/login/hecho" >
                        <div class="form-goup" id="user-group">
                            <input type="text" class="form-control" id="cedulaField" name="cedulaField" placeholder="Ingrese su Id" value="<%=form.get("cedulaField")[0]%>" title="<%=title("cedeulaField",errores)%>"/>                            
                        </div>        
                        <div class="form-goup" id="contrasena-group">
                            <input type="password" class="form-control" id="claveField"  name="claveField" placeholder="Ingrese su Clave" value="<%=form.get("claveField")[0]%>" title="<%=title("claveField",errores)%>"/>                            
                        </div>
                        <div class="text-info">
...
<%!
  private Map<String,String[]> getForm(Model model){
       ...
       values.put("claveField", new String[]{model.getUser().getClave()});
